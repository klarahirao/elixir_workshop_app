defmodule ElixirWorkshopApp.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ElixirWorkshopApp.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ElixirWorkshopApp.ErrorHelpers.translate_error/1)
